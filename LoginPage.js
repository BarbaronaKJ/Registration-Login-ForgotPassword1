...
const LoginPage = ({ navigation }) => {
  ...
  return (
    <PaperProvider>
      ...
      <Image source={require('./assets/ustp-logo.png')} style={styles.logo} />
        ...
        <Text style={styles.header2}>Registration-Login-ForgotPassword App By Kenth Jonard B. Barbarona | BSIT-3R13</Text>
      </View>
    </PaperProvider>
  );
};
